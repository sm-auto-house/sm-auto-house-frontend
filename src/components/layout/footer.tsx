      ...
      <Container>
        ...
        <div className="grid gap-12 py-16 lg:grid-cols-12 lg:gap-10 lg:py-24">
          ...
          <nav className="lg:col-span-2" aria-label="Footer">
            <Reveal direction="up" delay={0.06}>
              <h3 className="font-tech text-[0.5625rem] uppercase tracking-[0.17em] text-carbon-500">
                Navigate
              </h3>
        ...
        <div className="relative border-t border-ink/[0.07] pt-10">
          <Reveal direction="up" amount={0.2}>
            <p
              aria-hidden
              className="select-none font-display text-[clamp(2.5rem,13vw,11rem)] font-extrabold uppercase leading-[0.82] tracking-[-0.025em] text-transparent [-webkit-text-stroke:1px_var(--hairline)]"
            >
              SM Auto House
            </p>
          </Reveal>
        ...
        <div className="flex flex-col gap-6 border-t border-ink/[0.07] py-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-tech text-[0.625rem] uppercase tracking-[0.12em] text-carbon-500">
            © {year} {site.legalName}. All rights reserved.
          </p>

          <p className="font-tech text-[0.625rem] uppercase tracking-[0.1em] text-carbon-300">
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 self-start font-tech text-[0.625rem] uppercase tracking-[0.12em] text-carbon-500 transition-colors duration-300 hover:text-ink sm:self-auto"
          >
            Back to top
            <ArrowUp
